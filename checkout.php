...
<form action="" method="post">
   ...
   <input type="hidden" id="address" name="address" value="<?= $fetch_profile['address'] ?>">
   ...
   <div class="user-info">
      ...
      <select id="payment_method" name="method" class="box" required>
      ...
      <input id="place_order_btn" type="submit" value="Place Order" class="btn" style="width:100%; background:var(--red); color:var(--white);" name="submit" disabled>
   </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkFields() {
        if (addressField.value !== '' && paymentMethodField.value !== '') {
    ...
    // Add event listeners
    paymentMethodField.addEventListener('change', checkFields);
});
</script>
